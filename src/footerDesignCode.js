...
/* ©2020 DePaul iD Lab. All Rights Reserved. */
...
background: url(1280px-Depaul_U_Logo white.png);
        ...
        <div>
            ...
            <TabPanel>
               ...
               <div className="code-content">
                 <CopyToClipboard text={footerHtml.split("\n").map((i,key) => { return String(i+"\n")})}>
